...
@Component
public class CheckBinderExistDelegate implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(CheckBinderExistDelegate.class);
    ...
    public void execute(DelegateExecution execution) throws Exception {
        LOG.info("Checking binder with id and library id");
        ...
        criteria.add(Restrictions.eq("binderId.id", id));
        criteria.add(Restrictions.eq("binderId.libraryId", libraryId));
