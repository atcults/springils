...
@Component
public class CheckDepartmentExistDelegate implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(CheckDepartmentExistDelegate.class);
    ...
    public void execute(DelegateExecution execution) throws Exception {
        LOG.info("Checking department with id and library id");
        ...
        criteria.add(Restrictions.eq("departmentId.id", id));
        criteria.add(Restrictions.eq("departmentId.libraryId", libraryId));
