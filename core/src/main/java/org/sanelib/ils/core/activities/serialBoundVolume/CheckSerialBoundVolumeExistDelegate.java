...
@Component
public class CheckSerialBoundVolumeExistDelegate implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(CheckSerialBoundVolumeExistDelegate.class);
    ...
    public void execute(DelegateExecution execution) throws Exception {
        LOG.info("Checking serialBoundVolume with id and library id");
        ...
        criteria.add(Restrictions.eq("serialBoundVolumeId.id", id));
        criteria.add(Restrictions.eq("serialBoundVolumeId.libraryId", libraryId));
