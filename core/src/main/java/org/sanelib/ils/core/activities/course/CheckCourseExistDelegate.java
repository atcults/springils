...
@Component
public class CheckCourseExistDelegate implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(CheckCourseExistDelegate.class);
    ...
    public void execute(DelegateExecution execution) throws Exception {
        LOG.info("Checking course with id and library id");
        ...
        criteria.add(Restrictions.eq("courseId.id",id));
        criteria.add(Restrictions.eq("courseId.libraryId",libraryId));
