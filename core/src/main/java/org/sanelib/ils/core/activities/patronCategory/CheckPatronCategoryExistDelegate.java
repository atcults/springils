...
public class CheckPatronCategoryExistDelegate implements JavaDelegate {
	...
	private static final Logger LOG = LoggerFactory.getLogger(CheckPatronCategoryExistDelegate.class);
    ...
    public void execute(DelegateExecution execution) throws Exception {
        LOG.info("Checking patron category with id and library id");
