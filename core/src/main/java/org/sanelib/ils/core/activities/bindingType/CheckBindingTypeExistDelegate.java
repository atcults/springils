...
@Component
public class CheckBindingTypeExistDelegate implements JavaDelegate {

    private static final Logger LOG = LoggerFactory.getLogger(CheckBindingTypeExistDelegate.class);
    ...
    public void execute(DelegateExecution execution) throws Exception {
        LOG.info("Checking binding type with id and library id");
        ...
        criteria.add(Restrictions.eq("bindingTypeId.id", id));
        criteria.add(Restrictions.eq("bindingTypeId.libraryId", libraryId));
