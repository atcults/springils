...
@Component
public class CheckPatronExistDelegate implements JavaDelegate{

    private static final Logger LOG = LoggerFactory.getLogger(CheckPatronExistDelegate.class);
    ...
    public void execute(DelegateExecution execution) throws Exception {
        LOG.info("Checking Patron with code and library id");
        ...
        criteria.add(Restrictions.eq("patronCode.code", code));
        criteria.add(Restrictions.eq("patronCode.libraryId", libraryId));
