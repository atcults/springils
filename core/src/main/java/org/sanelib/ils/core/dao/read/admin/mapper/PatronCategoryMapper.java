...
public class PatronCategoryMapper implements ViewMapper<PatronCategoryView> {
    ...
    public PatronCategoryView map(final DataResultSet rs) throws SQLException {
        ...
        view.setAllowILLFromNet(Objects.equals(rs.getString(viewName, "ill_thru_net"), "1"));
        view.setAllowRenewalFromNet(Objects.equals(rs.getString(viewName, "renewal_thru_net"), "1"));
        view.setAllowMultipleCopies(Objects.equals(rs.getString(viewName, "allow_multiple_copies"), "1"));
