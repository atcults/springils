...
import org.sanelib.ils.api.converters.agency.UpdateAgencyConverter;
...
public class UpdateBindingTypeConverterTest {
    ...
    public void testUpdateUpdateBindingTypeSuccessExecute() throws Exception{
        ...
        assertEquals("Price is not mapped", dto.getPrice(), String.valueOf(updateBindingType.getPrice()));
